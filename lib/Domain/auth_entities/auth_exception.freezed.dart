...
/// @nodoc
abstract class _$$WrongEmailOrPassImplCopyWith<$Res> {
  factory _$$WrongEmailOrPassImplCopyWith(_$WrongEmailOrPassImpl value,
          $Res Function(_$WrongEmailOrPassImpl) then) =
      __$$WrongEmailOrPassImplCopyWithImpl<$Res>;
}

/// @nodoc
class __$$WrongEmailOrPassImplCopyWithImpl<$Res>
    extends _$AuthExceptionCopyWithImpl<$Res, _$WrongEmailOrPassImpl>
    implements _$$WrongEmailOrPassImplCopyWith<$Res> {
  __$$WrongEmailOrPassImplCopyWithImpl(_$WrongEmailOrPassImpl _value,
      $Res Function(_$WrongEmailOrPassImpl) _then)
      : super(_value, _then);
}

/// @nodoc

class _$WrongEmailOrPassImpl implements _WrongEmailOrPass {
  const _$WrongEmailOrPassImpl();
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is _$WrongEmailOrPassImpl);
  }
...
abstract class _WrongEmailOrPass implements AuthException {
  const factory _WrongEmailOrPass() = _$WrongEmailOrPassImpl;
}
